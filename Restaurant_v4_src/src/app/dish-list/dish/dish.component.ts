...
export class DishComponent implements OnInit {
  ...
  constructor(public Dishes:ListOfDishesService,public currencies:CurrenciesService ,public ShopList:ShopListService,public authService:AuthService) {
  }
  ...
  add(){
    this.Dishes.decrementQuantity(this.id,this.quantity);
    this.ShopList.add(this.name,this.price);
  }

  remove(){
    this.Dishes.incrementQuantity(this.id,this.quantity);
